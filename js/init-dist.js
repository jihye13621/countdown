...
// @prepros-append sources/calendar.js
// @prepros-append sources/countdown.js
// @prepros-append sources/spinning.js
// @prepros-append sources/animate-viewport.js
// @prepros-append sources/confetti.js
// @prepros-append sources/stl-loader.js
// @prepros-append sources/cake.js
...
return FC; // export for Node/CommonJS
  ...
  $(document).ready(function() {
	...
	dayClick: function(date, jsEvent, view) {
		...
		var clicked = moment(date).format('MM/DD');
		clearInterval(interval);
		$('#message-birthday').hide();
...
function calendarConfetti() {
    var end = Date.now() + (8 * 1000);

    var colors = ['#29b6f6', '#ffffff', '#03a9f4'];
    (function frame() {
    confetti({
        particleCount: 2,
        angle: 60,
